defmodule PhoenixGenStealer do
  ...
  def steal(destination, opts \\ []) do
    ...
    short_uppercase = Keyword.get(opts, :short_uppercase, uppercase)
...
PhoenixGenStealer.steal(".",
  # Required:
  lowercase: "mix_codegen_gap",
  # All optional:
  uppercase: "MixCodegenGap",
  short_lowercase: "codegap",
  short_uppercase: "Codegap"
)

defmodule Mix.Tasks.Codegap.Digest.Clean do
  use Mix.Task
  ...
  in the last hour.
      ...
      mix codegap.digest.clean
      mix codegap.digest.clean -o /www/public
      mix codegap.digest.clean --age 600 --keep 3
  ...
  def run(args) do
    ...
    case MixCodegenGap.Digester.clean(output_path, age, keep) do
      :ok ->

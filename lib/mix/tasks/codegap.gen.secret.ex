defmodule Mix.Tasks.Codegap.Gen.Secret do
  @shortdoc "Generates a secret"

  @moduledoc """
  Generates a secret and prints it to the terminal.

      mix codegap.gen.secret [length]

  By default, mix codegap.gen.secret generates a key 64 characters long.
  ...
  defp invalid_args! do
    Mix.raise "mix codegap.gen.secret expects a length as integer or no argument at all"
  end
end

defmodule Mix.Tasks.Codegap.Gen.Context do
  ...
  Generates a context with functions around an Ecto schema.
      ...
      mix codegap.gen.context Accounts User users name:string age:integer
  ...
  a `--table` option may be provided. For example:
      ...
      mix codegap.gen.context Accounts User users --table cms_users
  ...
  defp inject_tests(%Context{test_file: test_file} = context, paths, binding) do
    ...
    paths
    |> Mix.MixCodegenGap.eval_from("priv/templates/codegap.gen.context/test_cases.exs", binding)
  ...
  def raise_with_help(msg) do
    ...
    For example:
        ...
        mix codegap.gen.html Accounts User users name:string
        mix codegap.gen.json Accounts User users name:string
        mix codegap.gen.context Accounts User users name:string

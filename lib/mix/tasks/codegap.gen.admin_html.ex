defmodule Mix.Tasks.Codegap.Gen.AdminHtml do
  @shortdoc "Generates controller, views, and context for an HTML resource suitable for Admins"

  @moduledoc """
  Generates controller, views, and context for an HTML resource.

      mix codegap.gen.html Accounts User users name:string age:integer
  ...
  in your applications `:generators` configuration. When set, the MixCodegenGap
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix codegap.gen.html Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix codegap.gen.html Sales User users --web Sales
  ...
  a `--table` option may be provided. For example:
      ...
      mix codegap.gen.html Accounts User users --table cms_users
  ...
  Read the documentation for `codegap.gen.schema` for more information on
  attributes.
  """
  use Mix.Task
  ...
  def run(args) do
    if Mix.Project.umbrella?() do
      Mix.raise("mix codegap.gen.admin_html can only be run inside an application directory")
    end
  ...
  def files_to_be_generated(%Context{schema: schema, context_app: context_app}) do
    ...
    [
      ...
      {:eex, "filters.html.eex",
       Path.join([web_prefix, "templates", web_path, schema.singular, "filters.html.eex"])},
      {:eex, "table.html.eex",
       Path.join([web_prefix, "templates", web_path, schema.singular, "table.html.eex"])}
    ] ++
      [
        {:eex, "controller.ex",
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.MixCodegenGap.copy_from(paths, "priv/templates/codegap.gen.admin_html", binding, files)
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your #{schema.web_namespace} :browser scope in #{
        Mix.MixCodegenGap.web_path(ctx_app)
      }/router.ex:
      ...
      Add the resource to your browser scope in #{Mix.MixCodegenGap.web_path(ctx_app)}/router.ex:

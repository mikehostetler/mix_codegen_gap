defmodule Mix.Tasks.Codegap.Gen.Json do
  ...
  Generates controller, views, and context for a JSON resource.
      ...
      mix codegap.gen.json Accounts User users name:string age:integer
  ...
  Alternatively, the `--context-app` option may be supplied to the generator:
      ...
      mix codegap.gen.json Sales User users --context-app warehouse
  ...
  module name, for example:
      ...
      mix codegap.gen.json Sales User users --web Sales
  ...
  a `--table` option may be provided. For example:
      ...
      mix codegap.gen.json Accounts User users --table cms_users
  ...
  alias Mix.MixCodegenGap.Context
  alias Mix.Tasks.Codegap.Gen

  @doc false
  def run(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix codegap.gen.json can only be run inside an application directory"
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.MixCodegenGap.copy_from paths, "priv/templates/codegap.gen.json", binding, files
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your #{schema.web_namespace} :api scope in #{Mix.MixCodegenGap.web_path(ctx_app)}/router.ex:
      ...
      Add the resource to your :api scope in #{Mix.MixCodegenGap.web_path(ctx_app)}/router.ex:

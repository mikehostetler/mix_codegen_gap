defmodule Mix.Tasks.Codegap.Gen.Html do
  ...
  def run(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix codegap.gen.html can only be run inside an application directory"
    end
  ...
  def copy_new_files(%Context{} = context, paths, binding) do
    ...
    Mix.MixCodegenGap.copy_from(paths, "priv/templates/codegap.gen.html", binding, files)
  ...
  def print_shell_instructions(%Context{schema: schema, context_app: ctx_app} = context) do
    if schema.web_namespace do
      ...
      Add the resource to your #{schema.web_namespace} :browser scope in #{Mix.MixCodegenGap.web_path(ctx_app)}/router.ex:

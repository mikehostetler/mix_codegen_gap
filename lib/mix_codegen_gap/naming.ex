defmodule MixCodegenGap.Naming do
  @moduledoc """
  Conveniences for inflecting and working with names in MixCodegenGap.
  """
  ...
  ## Examples
      ...
      iex> MixCodegenGap.Naming.resource_name(MyApp.User)
      "user"

      iex> MixCodegenGap.Naming.resource_name(MyApp.UserView, "View")
      "user"
  ...
  ## Examples
      ...
      iex> MixCodegenGap.Naming.unsuffix("MyApp.User", "View")
      "MyApp.User"

      iex> MixCodegenGap.Naming.unsuffix("MyApp.UserView", "View")
      "MyApp.User"
  ...
  ## Examples
      ...
      iex> MixCodegenGap.Naming.underscore("MyApp")
      "my_app"

  In general, `underscore` can be thought of as the reverse of
  `camelize`, however, in some cases formatting may be lost:

      MixCodegenGap.Naming.underscore "SAPExample"  #=> "sap_example"
      MixCodegenGap.Naming.camelize   "sap_example" #=> "SapExample"
  ...
  ## Examples
      ...
      iex> MixCodegenGap.Naming.camelize("my_app")
      "MyApp"

      iex> MixCodegenGap.Naming.camelize("my_app", :lower)
      "myApp"
  ...
  ## Examples
      ...
      iex> MixCodegenGap.Naming.humanize(:username)
      "Username"
      iex> MixCodegenGap.Naming.humanize(:created_at)
      "Created at"
      iex> MixCodegenGap.Naming.humanize("user_id")
      "User"
